...
<html lang="ko" dir="ltr">
  ...
  <body>
    ...
    <section>
      <div id="qna_view_div_main">
        <div id="qna_title">
          <h3>예약 문의 / Q&A</h3>
        </div>  <!-- end of qna_title -->
        <div id="write_form">
          <div id="write_row1">
        ...
        ?>
        <input type="button" onclick="location.href='write_edit_form.php?mode=update&num=<?=$num?>'" value=" 수정 ">
        ...
        ?>
        <input type="button" onclick="location.href='write_edit_form.php?mode=response&num=<?=$num?>'" value=" 답변 ">
