...
<html lang="ko" dir="ltr">
  <head>
    ...
    function check_delete(num) {
      ...
      if(result){
            window.location.href='./dml_board_notice.php?mode=delete&num='+num;
      }
    }
    </script>
    <title></title>
  ...
  <body>
    ...
    <section>
      <div id="notice_view_div_main">
        <div id="notice_title">
          <h3>공지</h3>
        </div>  <!-- end of notice_title -->
        <div id="write_form">
          <div id="write_row1">
        ...
        ?>
        <input type="button" onclick="location.href='write_edit_form_notice.php?mode=update&num=<?=$num?>'" value=" 수정 ">
        ...
        ?>
        <input type="button" onclick="location.href='write_edit_form_notice.php'" value=" 글쓰기 ">
        <?php
          }
        }
        ?>
        </div><!--end of write_button  -->
      </div><!--end of notice_view_div_main  -->
    </section>
    <footer>
